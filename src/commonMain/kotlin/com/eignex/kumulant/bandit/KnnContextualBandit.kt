 ...
 *
 * Standalone bandit — does not implement [ContextualBandit] because the per-arm state
 * is a history, not a sufficient statistic.
 */
class KnnContextualBandit(
    ...
    fun create(random: Random = this.random): KnnContextualBandit =
