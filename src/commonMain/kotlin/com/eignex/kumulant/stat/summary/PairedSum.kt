...
/**
 * Paired weighted-sum snapshot: `Σ wᵢ·xᵢ`, `Σ wᵢ·yᵢ`, and `Σ wᵢ`.
 *
...
/**
 * Weighted paired sum `(Σ wᵢ·xᵢ, Σ wᵢ·yᵢ)` with accumulated weight.
 *
 ...
 *
 * Numerical caveat matches [Sum]: very long mixed-magnitude streams accumulate
 * ulp drift on the order of √n. For compensated accumulation, consider running
...
class PairedSum(
    ...
    override fun create(concurrency: Concurrency?) = PairedSum(concurrency ?: this.concurrency)
}
