...
/**
 * Accumulates `(Σ wᵢ·xᵢ, Σ wᵢ)` where each update's value is interpreted as a
...
class BernoulliSum(
    ...
    override fun create(concurrency: Concurrency?) = BernoulliSum(concurrency ?: this.concurrency)
}
