...
class StatConfigsRoundTripTest {
    ...
    @Test fun materializeSeries_after_round_trip_matches_live_for_sum_mean_min_max() {
        ...
        listOf(1.0, 2.5, 0.5, 7.0).forEach { live.update(it); rebuilt.update(it) }
        ...
        assertEquals(live0[schema.mean].mean, rebuilt0[StatKey<com.eignex.kumulant.stat.summary.WeightedMeanResult>("mean")].mean)
